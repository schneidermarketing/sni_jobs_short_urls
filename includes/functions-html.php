...
function yourls_html_logo() {
	...
	<h1>
		...
		<img src="<?php yourls_site_url(); ?>/images/img-schneider-logo.png" alt="Schneider National" title="Schneider National" border="0" style="border: 0px;float: right;margin: 20px 20px 0 0;" /></a>
	</h1>
	<?php
	...
	<div id="new_url">
		<div>
			<form id="new_url_form" action="" method="get">
				<?php # echo $url; ?>
				<div><strong><?php yourls_e( 'Enter the URL' ); ?></strong>:<input type="text" id="add-url" name="url" value="" class="text" size="80" />
